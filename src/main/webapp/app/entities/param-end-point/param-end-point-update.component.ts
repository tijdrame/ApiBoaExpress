...
export class ParamEndPointUpdateComponent implements OnInit {
  ...
  constructor(protected paramEndPointService: ParamEndPointService, protected activatedRoute: ActivatedRoute, private fb: FormBuilder) {}
  ...
  updateForm(paramEndPoint: IParamEndPoint): void {
  ...
  private createFromForm(): IParamEndPoint {
    return {
      ...new ParamEndPoint(),
