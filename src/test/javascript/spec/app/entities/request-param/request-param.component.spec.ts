...
import { RequestParamComponent } from 'app/entities/request-param/request-param.component';
...
describe('Component Tests', () => {
  describe('RequestParam Management Component', () => {
    let comp: RequestParamComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [RequestParamComponent],
        providers: [
          {
        ...
        .overrideTemplate(RequestParamComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.requestParams && comp.requestParams[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
